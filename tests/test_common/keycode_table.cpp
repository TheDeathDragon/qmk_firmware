...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_KEY_CANCELLATION_ON, "QK_KEY_CANCELLATION_ON"},
    {QK_KEY_CANCELLATION_OFF, "QK_KEY_CANCELLATION_OFF"},
    {QK_KEY_CANCELLATION_TOGGLE, "QK_KEY_CANCELLATION_TOGGLE"},
    {QK_KEY_E_MACRO_ON, "QK_KEY_E_MACRO_ON"},
    {QK_KEY_E_MACRO_OFF, "QK_KEY_E_MACRO_OFF"},
    {QK_KEY_E_MACRO_TOGGLE, "QK_KEY_E_MACRO_TOGGLE"},
    {QK_KB_0, "QK_KB_0"},
    {QK_KB_1, "QK_KB_1"},
    {QK_KB_2, "QK_KB_2"},
    {QK_KB_3, "QK_KB_3"},
